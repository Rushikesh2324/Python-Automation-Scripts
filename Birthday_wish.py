...
# this application is used to Automation Birthday mail sending 
# this application is written with the help of Python.org 
# you can find some related function on site
import pandas as pd
import datetime
import smtplib
import time
...
GMAIL_ID = '_______your_email_here'
GMAIL_PWD = '_______________your_password_here'
